  ...
  const termsContent = (
    <div className="space-y-6 text-sm leading-relaxed">
      <div>
        ...
        <p className="text-muted-foreground">
          Компания "Песок и Бетон" предоставляет услуги по поставке сыпучих строительных материалов 
          с доставкой на территории Москвы и Московской области.
        </p>
      </div>

      <div>
        <h3 className="font-bold text-base mb-3">2. Порядок оформления заказа</h3>
        <ul className="list-disc list-inside text-muted-foreground space-y-1">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          ...
          При обнаружении несоответствия качества материал подлежит замене.
        </p>
      </div>
